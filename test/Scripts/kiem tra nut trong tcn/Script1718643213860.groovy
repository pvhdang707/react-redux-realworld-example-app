...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Conduit/button_Follow Maksim Esteban'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Conduit/button_636'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Conduit/button_165'))
