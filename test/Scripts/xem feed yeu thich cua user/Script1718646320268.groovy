...
WebUI.rightClick(findTestObject('Object Repository/Page_Conduit/a_Favorited Articles'))

WebUI.click(findTestObject('Object Repository/Page_Conduit/a_Favorited Articles'))
