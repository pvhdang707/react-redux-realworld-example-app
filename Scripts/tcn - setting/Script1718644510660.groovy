...
WebUI.setText(findTestObject('Object Repository/Page_Conduit/input_Need an account_form-control form-control-lg'), 't85jFVmKXIc=')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Conduit/h1_Your Settings'), 'Your Settings')
