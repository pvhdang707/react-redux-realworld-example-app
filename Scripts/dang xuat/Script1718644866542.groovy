...
WebUI.click(findTestObject('Object Repository/Page_Conduit/button_Or click here to logout'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Conduit/a_Sign in'), 'Sign in')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Conduit/a_Sign up'), 'Sign up')
